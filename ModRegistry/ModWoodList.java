...
public enum ModWoodList implements TreeType {
	...
	ACACIA(ModList.BOP, 0x847956, 0x3E981A, "logs1", "colourizedLeaves1", "colourizedSaplings", 0, new int[]{0,8}, 0, VarType.INSTANCE),
	BOPMANGROVE(ModList.BOP, 0xDED1B5, 0x3E981A, "logs2", "colourizedLeaves1", "colourizedSaplings", 2, new int[]{1,9}, 1, VarType.INSTANCE),
	PALM(ModList.BOP, 0x936B40, 0x3E981A, "logs2", "colourizedLeaves1", "colourizedSaplings", 3, 2, 2, VarType.INSTANCE),
	REDWOOD(ModList.BOP, 0x722F0D, 0x3E981A, "logs3", "colourizedLeaves1", "colourizedSaplings", 0, new int[]{3,11}, 3, VarType.INSTANCE),
	BOPWILLOW(ModList.BOP, 0x767A47, 0x3E981A, "logs3", "colourizedLeaves2", "colourizedSaplings", 1, new int[]{0,8}, 4, VarType.INSTANCE),
