...
public enum ModWoodList implements TreeType {
	...
	PINKBIRCH(ModList.SATISFORESTRY,0xE5E4DB, 0xF795B5, 6, 20, "LOG", "LEAVES", "SAPLING", new int[]{0,4,8,12}, new int[]{0,4,8,12}, 0, VarType.INSTANCE),
	GIANTPINKTREE(ModList.SATISFORESTRY,0xE5E4DB, 0xF46E9B, 48, 192, "LOG", "LEAVES", "SAPLING", new int[]{1,5,9,13}, new int[]{1,5,9,13}, 1, VarType.INSTANCE),
	REDJUNGLE(ModList.SATISFORESTRY,0xE5E4DB, 0xCC515D, 15, 20, "LOG", "LEAVES", "SAPLING", new int[]{2,6,10,14}, new int[]{2,6,10,14}, 2, VarType.INSTANCE),
