...
public class SkyCheck extends Patcher {
	...
	protected void apply(ClassNode cn) {
		MethodNode m = ReikaASMHelper.getMethodByName(cn, "func_76619_d", "canBlockSeeTheSky", "(III)Z");
		...
		m.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "Reika/DragonAPI/Instantiable/Event/CanSeeSkyEvent", "fire", "(Lnet/minecraft/world/chunk/Chunk;III)Z", false));
