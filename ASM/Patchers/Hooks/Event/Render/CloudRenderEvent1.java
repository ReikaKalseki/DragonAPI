...
public class CloudRenderEvent1 extends Patcher {
	...
	protected void apply(ClassNode cn) {
		...
		m.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "Reika/DragonAPI/Instantiable/Event/Client/CloudRenderEvent", "fireNoRedirect", "(Lnet/minecraft/client/settings/GameSettings;)Z", false));
